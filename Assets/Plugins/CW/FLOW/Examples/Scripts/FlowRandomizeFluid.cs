...
namespace FLOW
{
	...
	[HelpURL(FlowCommon.HelpUrlPrefix + "FlowRandomizeFluid")]
	[AddComponentMenu(FlowCommon.ComponentMenuPrefix + "Randomize Fluid")]
...
namespace FLOW
{
	...
	public class FlowRandomizeFluid_Editor : CwEditor
	{
