...
namespace FLOW
{
	...
	[HelpURL(FlowCommon.HelpUrlPrefix + "FlowFormatString")]
	[AddComponentMenu(FlowCommon.ComponentMenuPrefix + "Format String")]
	public class FlowFormatString : MonoBehaviour
	{
...
{
	using UnityEditor;
	using TARGET = FlowFormatString;

	[CanEditMultipleObjects]
	[CustomEditor(typeof(TARGET))]
	public class FlowFormatString_Editor : CwEditor
	{
